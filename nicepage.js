!(function (t) {
  ...
  9770: function (t, e, n) {
    ...
    var Animation = n(9771),
      i = n(187);
    n(419), (window.uAnimation = new Animation(i.instance()).init());
  },
  9771: function (t, e, n) {
    "use strict";
    ...
    (i.prototype.initClearButton = function t() {
      ...
      (i.prototype.reset = function t() {
        var e = this.canvas.parentNode,
          ...
          a;
        if (!i)
          (o = (a = n.parents(".u-carousel-item")).css(["position", "left"])),
        ...
        var u = window.getComputedStyle(e, null),
          ...
          c = (l / 100) * 20,
          h = (f / 100) * 20;
        if (!i) a.removeClass("u-active"), a.css(o);
        var p = {
            width: l,
            height: f,
            lineWidth: 2,
          ...
          m = this.canvas.getContext("2d");
        (m.canvas.width = p.width),
          (m.canvas.height = p.height),
          m.clearRect(0, 0, p.width, p.height),
          (m.lineWidth = p.lineWidth),
          (m.strokeStyle = p.strokeStyle),
          (m.fillStyle = p.fillStyle),
          m.fillRect(0, 0, p.width, p.height),
          m.beginPath(),
          m.moveTo(p.signatureLine.startX, p.signatureLine.startY),
          m.lineTo(p.signatureLine.endX, p.signatureLine.endY),
          m.stroke(),
